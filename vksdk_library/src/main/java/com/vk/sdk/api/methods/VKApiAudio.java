...
public class VKApiAudio extends VKApiBase {
     ...
     * https://vk.com/dev/audio.getUploadServer
     */
    private VKRequest getUploadServer(VKParameters params) {
     ...
     * https://vk.com/dev/audio.getAlbums
     */
    private VKRequest getAlbums(VKParameters params) {
     ...
     * https://vk.com/dev/audio.getBroadcastList
     */
    private VKRequest getBroadcastList(VKParameters params) {
     ...
     * https://vk.com/dev/audio.getRecommendations
     */
    private VKRequest getRecommendations(VKParameters params) {
     ...
     * https://vk.com/dev/audio.getPopular
     */
    private VKRequest getPopular(VKParameters params) {
